...
public class MemberService {
	...
	public ResponsDto SignUP(MemberDto memberDto) {
		try {
	...
	public ResponsDto FindId(FindIdDto findIdDto) {
	...
	public ResponsDto FindPassword(FindPasswordDto findPasswordDto) {
		MemberEntity memberEntity;
		try {
